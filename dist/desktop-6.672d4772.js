document.addEventListener("DOMContentLoaded", (event)=>{
    ...
    if (!localStorage.getItem("loggedIn")) window.location.href = "./desktop.html"; // Redirect to desktop page
    ...
    if (continueShoppingButton) continueShoppingButton.addEventListener("click", function(e) {
        if (localStorage.getItem("loggedIn")) window.location.href = "./after_login.html"; // Redirect to after login page
        else window.location.href = "./desktop.html"; // Redirect to desktop page
    });
});

//# sourceMappingURL=desktop-6.672d4772.js.map
